...
public final class CallEditor extends ExprEditor {
   ...
   // System.out.flush() ??
   private static String CODE1 = CODE_SET + CODE_INDEX + CODE_SEP1 + CODE_END;
   private static String CODE2 = CODE_GET + CODE_INDEX + CODE_SEP2 + CODE_END;
   private static String CODE3 = CODE_REMOVE + CODE_INDEX + CODE_SEP2 + CODE_END;
   private static String CODE4 = CODE_ADD_VAL + CODE_INDEX + CODE_SEP2 + CODE_END;
