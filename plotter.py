...
class Plotter:
    ...
    @staticmethod
    def plot_curve(
            pd_data, title=None, x_label=None, y_label=None, output_filename=None, legends=None, figsize=(3, 2),
            marker=".", linestyle='-', markersize=10, loc=2, loc_anchor=False, linewidth=1, markevery=None,
            colors=None, ylim=None, xlim=None, vline_at=None, vline_style='-', vline_color='blue', legend_frameon=True,
            legend_shadow=False, rugs=None, hline_at=None, hline_style='-', hline_color='blue', hline_width=1, dpi=300,
            legend_ms=1, xticks_args=None, yticks_args=None, grid=False, tight_layout=None, x_scale='linear',
            annotate=None, y_scale='linear', no_axis=False, legend_ncol=1,  xtick_rotation=0, zorder_curves=3,
            **kwargs):
    ...
    def plot_heatmap(matrix=None, matrixdf=None, main_title=None, output_filename=None, titles=None, ordered=False,
        ...
        if ordered:
            ...
            if titles_x:
                ...
                heatmap_subplot.tick_params(labelbottom='off', labeltop='on')
            if titles_y:
