...
public final class Difference {
   ...
   static class Element {
      ...
      int costSubst (final Element other) {
         ...
         } else if (this.element.equals("add")) {
            // same state
            if (other.element.equals("add") && this.arg2.equals(other.arg2)) {
               //System.out.printf ("EQUAL STATE. %s ==  %s%n", this.arg2, other.arg2);
               return 0;
            } else if (other.element.equals("add")) {
               return 1;
            } else {
               return 2;
            }
         } else if (this.element.equals("remove")) {
            // same state
            if (other.element.equals("remove") && this.arg2.equals(other.arg2)) {
               //System.out.printf ("EQUAL STATE. %s ==  %s%n", this.arg2, other.arg2);
               return 0;
            } else if (other.element.equals("remove")) {
               return 1;
            } else {
               return 2;
            }
