...
def getWeights():
    ...
    timeoutDistWeight = 5.0 # 6/28, 5/17 on selection sort when run by itself (0.214) ** Not useful, reduntent with exit status
    ...
    editDistWeight = 9.0 # 20/28, 9/17 on selection sort when run by itself (0.714)
