...
/*
 * The concept is correct but this solution doesn't always find the correct answer due to the following
 * 
 * There is other checks missing where certain elements are not checked with the way this works
 */

public class BinarySearchReference4 {
